...
public class FlyWheelSystem extends Subsystem {
	...
	public final static double kSpeedMax = 1600;
	...
	private static final double kFGain = 0.1097; //from code sample
	private static final double kPGain = 0.22; //from code sample
	private static final double kIGain = 0.0; //from code sample
	private static final double kDGain = 0.0; //from code sample
	...
	private void configFeedback() {
		...
		flyWheelMotor.reverseSensor(false); //TODO: Sensor needs to read same direction as motor spins up (positive-positive).
