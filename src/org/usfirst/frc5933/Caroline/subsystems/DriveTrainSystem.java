...
public class DriveTrainSystem extends Subsystem {
	...
	/**
	 * Use this function in a periodic method to tickle the configured motors to move to the setpoint, within acceptable precision.
	 * @param distance
	 * @param config
	 * @param precision
	 * @return Whether or not the robot has reached the distance.
	 */
	 ...
	 */
	/**
	 * Use this method to set the arc length each motor will have to turn for the robot to rotate the set number of degrees.
	 * @param dir
	 * @param degrees
	 * @param aroundCenter
	 */
	...
	/**
	 * This function should be called in the periodic and isFinished methods of a command to tickle the drive
	 * train motors into moving the arc length specified through setTurningMotionMagic().
	 * @param precision
	 * @return Whether or not the robot has reached the degrees specified in setTurningMotionMagic().
	 */
