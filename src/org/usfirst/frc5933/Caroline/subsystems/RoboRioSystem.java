...
public class RoboRioSystem extends Subsystem {
	...
	private final DigitalInput[] dIP_Array_ = { // just add more dIPs to this
												// and the code will adapt.
			RobotMap.roboRioSystemDIP1, RobotMap.roboRioSystemDIP2, RobotMap.roboRioSystemDIP3,
			RobotMap.roboRioSystemDIP4 };
	// BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTANTS

	// END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTANTS

	// the set of DIPs below is actually unnecessary as long as there are the
	// same ones referenced above.
	...
	public int getDIP() {
		...
		for (DigitalInput dIP : dIP_Array_) {
			...
			} // so, the above code will take a dIP array of any length and turn
				// it into an integer.
			count++; // next index...
		}
