...
public class GearCollectionSystem extends Subsystem {
    ...
    private final SpeedController frontFlapper = RobotMap.gearCollectionSystemFrontFlapper;
    private final SpeedController backFlapper = RobotMap.gearCollectionSystemBackFlapper;
