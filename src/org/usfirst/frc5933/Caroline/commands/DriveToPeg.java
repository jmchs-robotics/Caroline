...
public class DriveToPeg extends Command {
	...
	private static final double kAcceptableDist = 13;
	...
	private static double leftCoefficient = 1.2;
	...
	protected void initialize() {
		...
		leftCoefficient = Robot.driveTrainSystem.getLeftCoefficient();
		finished = false;
	}
	...
	protected void execute() {
		...
		if (!finished) {
			...
			case SocketVision.NADA:
				...
				Robot.driveTrainSystem.set((kDefaultDriveSpeed) * leftCoefficient, kDefaultDriveSpeed);
				break;
			case SocketVision.LEFT:
				// always slow down the side you want to turn to.
				// Kinda like a boat's rudder.
				Robot.driveTrainSystem.set((kDefaultDriveSpeed - driveSpeedModifier) * leftCoefficient, kDefaultDriveSpeed);
				break;
			case SocketVision.RIGHT:
				Robot.driveTrainSystem.set(kDefaultDriveSpeed * leftCoefficient, kDefaultDriveSpeed - driveSpeedModifier);
				break;
			default:
				// go slower if something isn't working
				Robot.driveTrainSystem.set((kDefaultDriveSpeed / 2) * leftCoefficient, kDefaultDriveSpeed / 2);
