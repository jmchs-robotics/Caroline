...
public class RedAttackGearPosition1 extends CommandGroup {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
        ...
        addSequential(new ComplexDriveStraight(87, DriveTrainConfigurations.Auto_5F1_LeftLead,5));
    	
    	//addSequential(new SimpleDriveStraight());
        addSequential(new TurnRight(false,360,5));
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
		...
		// exist yet?
//        ComplexDriveStraight.setDriveTrainConfig(DriveTrainConfigurations.Auto_2F1x2);
//        ComplexDriveStraight.setInches(87);
//        
