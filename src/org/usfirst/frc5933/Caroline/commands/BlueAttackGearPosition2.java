 ...
 *
 */
public class BlueAttackGearPosition2 extends CommandGroup {

	// BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public BlueAttackGearPosition2() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
        addSequential(new DefaultAutonomousCommand());	//push gently
		...
		// exist yet?
		DefaultAutonomousCommand.setTheTimeout(5);
	}
}
