 ...
 *
 */
public class RedAttackGearPosition3 extends CommandGroup {

	// BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public RedAttackGearPosition3() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
        ...
        addSequential(new ComplexDriveStraight(87,DriveTrainConfigurations.Auto_2F1x2,5));
        addSequential(new TurnLeft(true,360,5));
