...
public class DefaultAutonomousCommand extends Command {
	private double timeout_ = 2.5;
	final static double kleftCoefficent = 1.05;
	...
	public DefaultAutonomousCommand(int i) {
		timeout_=i;
	...
	protected void execute() {
		Robot.driveTrainSystem.tankDrive(-0.4 * kleftCoefficent, -0.4);
	}
