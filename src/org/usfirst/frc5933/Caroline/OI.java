...
public class OI {
	...
	public OI() {
        ...
        backButtonSub.whenPressed(new StopFlaps());
        ...
        lToggle.whileHeld(new AgitateFaster());
        rToggle = new JoystickButton(driverJoystick, 10);
        rToggle.whileHeld(new AgitateSlower());
        ...
        yButton.whenPressed(new FlyWheelMode());
        ...
        xButton.whenPressed(new ToggleShootingVision());
        ...
        SmartDashboard.putData("FlyWheelMode", new FlyWheelMode());
        SmartDashboard.putData("ToggleShootingVision", new ToggleShootingVision());
        SmartDashboard.putData("StopFlaps", new StopFlaps());
