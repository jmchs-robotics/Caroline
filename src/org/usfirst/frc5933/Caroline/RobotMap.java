...
public class RobotMap {
	...
	public static void init() {
		...
		LiveWindow.addActuator("GearCollectionSystem", "FrontFlapperMotor",
				(Spark) gearCollectionSystemFrontFlapperMotor);

		gearCollectionSystemBackFlapperMotor = new Spark(1);
		LiveWindow.addActuator("GearCollectionSystem", "BackFlapperMotor",
				(Spark) gearCollectionSystemBackFlapperMotor);

		gearCollectionSystemCloseBackFlapperLimitSwitch = new DigitalInput(0);
		LiveWindow.addSensor("GearCollectionSystem", "CloseBackFlapperLimitSwitch",
				gearCollectionSystemCloseBackFlapperLimitSwitch);

		gearCollectionSystemCloseFrontFlapperLimitSwitch = new DigitalInput(1);
		LiveWindow.addSensor("GearCollectionSystem", "CloseFrontFlapperLimitSwitch",
				gearCollectionSystemCloseFrontFlapperLimitSwitch);

		gearCollectionSystemOpenBackFlapperLimitSwitch = new DigitalInput(2);
		LiveWindow.addSensor("GearCollectionSystem", "OpenBackFlapperLimitSwitch",
				gearCollectionSystemOpenBackFlapperLimitSwitch);
